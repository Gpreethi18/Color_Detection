...
def filter_roi(roi):
    ...
    # Define thresholds for HSV values (adjust these based on testing)
...
while True:
    ...
    for box in boxes:
        ...
        dominant_color = find_dominant_color(filtered_roi, k=5)  # Increased clusters for more accuracy
        ...
        cv2.putText(frame, rgb_text, (x, y - 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.putText(frame, color_text, (x, y - 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
